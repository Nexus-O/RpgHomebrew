...
/* ── Nav items ── */
const NAV = [
  { icon: "⚔️", label: "Dashboard",   href: "#",  active: true  },
  { icon: "🧙", label: "Personagens", href: "#",  active: false },
  { icon: "📜", label: "Campanhas",   href: "#",  active: false },
  { icon: "🐉", label: "Bestiário",   href: "#",  active: false },
  { icon: "💎", label: "Itens",       href: "#",  active: false },
    ...
    <>
      ...
      <style>{`
        ...
        .sidebar {
          ...
          height: 100vh;
          background: #080202;
          border-right: 1px solid rgba(100,15,15,0.5);
          display: flex;
        ...
        .sidebar-logo {
          ...
          border-bottom: 1px solid rgba(100,15,15,0.35);
        }
        .logo-name {
        ...
        .nav-item:hover {
          ...
          border-color: rgba(100,20,20,0.3);
          color: #fff;
        }
        ...
        .nav-item { color: #8a6060; }
        .nav-item:hover, .nav-item.active { color: #e0d4d4; }

        /* User box */
        .sidebar-user {
          padding: 16px;
          border-top: 1px solid rgba(100,15,15,0.35);
          display: flex;
          align-items: center;
          gap: 10px;
        }
        ...
        .main {
          ...
          min-height: 100vh;
          background:
            radial-gradient(ellipse 80% 40% at 80% 0%, rgba(80,8,8,0.12) 0%, transparent 60%),
            #050101;
        }
        ...
        .topbar {
          ...
          border-bottom: 1px solid rgba(100,15,15,0.3);
        }
        ...
        .section-divider {
          height: 1px;
          background: linear-gradient(to right, #cc1a1a 0%, rgba(100,15,15,0.2) 60%, transparent 100%);
          margin-bottom: 2rem;
          margin-top: 0.5rem;
          width: 160px;
        }
        ...
        .stats-grid {
          ...
          border: 1px solid rgba(100,15,15,0.2);
        }
        ...
        .panel {
          ...
          border: 1px solid rgba(100,15,15,0.3);
          overflow: hidden;
          animation: fade-in 0.7s 0.3s ease both;
        }
        .panel-header {
          padding: 1.25rem 1.5rem;
          border-bottom: 1px solid rgba(100,15,15,0.25);
          display: flex;
          align-items: center;
          justify-content: space-between;
        }
        ...
        .activity-item {
          ...
          gap: 12px;
          padding: 1rem 1.5rem;
          border-bottom: 1px solid rgba(60,10,10,0.2);
        ...
        .activity-dot {
          ...
          flex-shrink: 0;
          margin-top: 6px;
          box-shadow: 0 0 6px rgba(200,20,20,0.5);
        }
        ...
        .quick-btn {
          ...
          padding: 12px 14px;
          background: transparent;
          border: 1px solid rgba(80,12,12,0.35);
          color: #8a6060;
          cursor: pointer;
          font-family: 'Cinzel', serif;
          font-size: 0.65rem;
        ...
        @media (max-width: 768px) {
          .overlay { display: ${sideOpen ? "block" : "none"}; }
        }
      `}</style>
